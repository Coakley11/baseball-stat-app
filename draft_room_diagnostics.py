...
def init_join_flow_diagnostics(session: dict[str, Any], *, clicked: bool = False) -> dict[str, Any]:
    ...
    diag: dict[str, Any] = {
        ...
        "join_code": "",
        "requested_team": "",
        "selectbox_return_value": "",
        "session_team_widget_value": "",
        "captured_requested_team": "",
        "team_fallback_used": False,
        "room_lookup_attempted": False,
...
def get_pre_draft_shared_room_diagnostics(session: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "selectbox_return_value": str(join_diag.get("selectbox_return_value") or ""),
        "session_team_widget_value": str(join_diag.get("session_team_widget_value") or ""),
        "captured_requested_team": str(join_diag.get("captured_requested_team") or ""),
        "team_fallback_used": bool(join_diag.get("team_fallback_used")),
        "room_lookup_attempted": bool(join_diag.get("room_lookup_attempted")),
