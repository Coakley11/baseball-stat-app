...
START_STEP_USER_LABELS: dict[str, str] = {
    ...
    "shared_write_start": "Creating shared room…",
    "shared_room_create_start": "Creating shared room…",
    "commissioner_registered": "Registering commissioner…",
    "shared_write_end": "Opening lobby…",
    "shared_room_create_end": "Opening lobby…",
    "session_installed": "Opening lobby…",
    "solo_started": "Opening draft…",
    "local_save_start": "Opening draft…",
    "local_save_end": "Opening draft…",
    "lifecycle_resolved": "Opening draft…",
    "timer_deadline_set": "Opening draft…",
    "pool_loaded": "Building player pool…",
    "recommendations_loaded": "Opening draft…",
