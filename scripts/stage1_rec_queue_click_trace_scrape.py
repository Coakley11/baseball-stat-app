...
_RENDER_TRACE_ROW_FROM_EL_JS = """
              return {
                ...
                heavy_paint_done_at_render: el.getAttribute('data-heavy-paint-done-at-render') || '',
                interactive_owner: el.getAttribute('data-interactive-owner') || '',
                paint_via: el.getAttribute('data-paint-via') || '',
                inside_fragment: el.getAttribute('data-inside-fragment') || '',
                fragment_run_every: el.getAttribute('data-fragment-run-every') || '',
                server_registered: el.getAttribute('data-server-registered') || '',
                callback_attached: el.getAttribute('data-callback-attached') || '',
