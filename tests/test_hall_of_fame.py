...
class HallOfFameDataTests(unittest.TestCase):
    ...
    def test_hof_case_packet_required_fields(self) -> None:
        ...
        self.assertIn("target_cohort_ranks", packet)
        self.assertIn("cohort_selectivity", packet)
        self.assertIn("position_stat_ranks", packet)
    ...
    def test_ami_label_and_guidance_exact(self) -> None:
        ...
        self.assertIn("Position-Based Hall of Fame Case", guidance)
        self.assertIn("Summary Judgment", guidance)
        self.assertIn("supporting evidence", guidance)
        self.assertIn("Never say", guidance)
