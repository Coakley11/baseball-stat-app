...
_WRAPPER_SPECS: tuple[tuple[str, str, str], ...] = (
    ...
    ("streamlit.runtime.scriptrunner.script_runner", "ScriptRunner", "request_rerun", "_solo_scriptrunner_rerun_wrapped"),
    ("streamlit.runtime.scriptrunner.script_runner", "ScriptRunner", "_run_script", "_solo_scriptrunner_run_script_wrapped"),
    (
        "streamlit.runtime.scriptrunner_utils.script_requests",
        "ScriptRequests",
        "request_rerun",
        "_solo_scriptrequests_rerun_wrapped",
    ),
    (
        "streamlit.runtime.scriptrunner_utils.script_requests",
        "ScriptRequests",
        "on_scriptrunner_yield",
        "_solo_scriptrequests_yield_wrapped",
    ),
    (
        "streamlit.runtime.scriptrunner_utils.script_requests",
        "ScriptRequests",
        "on_scriptrunner_ready",
        "_solo_scriptrequests_ready_wrapped",
    ),
